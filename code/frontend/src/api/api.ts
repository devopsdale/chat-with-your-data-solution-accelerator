...
export async function getUserInfo(): Promise<any[]> {
  ...
  export const historyUpdate = async (messages: any[], convId: string): Promise<any> => {
...
//   }
  ...
  export const historyEnsure = async (): Promise<any> => {
...
//   export const frontendSettings = async (): Promise<any | null> => {
